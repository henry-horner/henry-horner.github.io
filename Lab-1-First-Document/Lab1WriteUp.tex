...
\tightlist
\item
  Recreate this section in your \textbf{Lab1WriteUp.qmd} file.
\end{itemize}
...
\pandocbounded{\includegraphics[keepaspectratio]{Lab1WriteUp_files/figure-pdf/fig-one-quadratic-1.pdf}}
...
Note that you can ask for citations for \textbf{R} packages using the
\textbf{citation()} function.
