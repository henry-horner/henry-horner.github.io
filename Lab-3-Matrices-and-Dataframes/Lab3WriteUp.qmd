...
(determinant_T = det(T))
```
*This area is the same as the area of the original transformation of $A$ without using the $k$ in matrix $M$. This is correct since this transformation did not effect area. It is considerablly more skinny and tall than the original.*
